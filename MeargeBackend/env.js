module.exports = {
  ...
  web: {
    frontendOrigins: [
      "http://localhost:5173",
      "http://127.0.0.1:5173",
      "https://nexusglobalshop.com",
      "https://www.nexusglobalshop.com",
      "https://connect.nexusglobalshop.com",
    ],
  ...
  // backend: {
  //   database: {
  //     name: "nexusglobal_shop",
  //     user: "nexusglobal_nexusglobal-user",
  //     password: "7$uU*xOXQqKw5B9S",
  //     host: "localhost",
  //     dialect: "mysql",
  //   },
  //   jwtSecret: "secretkey",
