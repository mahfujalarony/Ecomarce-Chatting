...
const app = express()
const server = global.__MARGE_SHARED_SERVER || http.createServer(app)
...
const APP_PUBLIC_URL = config.appPublicUrl || 'http://localhost:5173'
...
async function start() {
  try {
    ...
    if (!global.__MARGE_SHARED_SERVER) {
      server.listen(port, () => {
