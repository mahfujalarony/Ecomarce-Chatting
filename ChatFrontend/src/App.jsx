...
import './App.css'
import { ENABLE_WEB_PUSH, SOCKET_PATH, SOCKET_URL, UPLOAD_FILE_FIELD, UPLOAD_SERVER_URL, ZEGO_APP_ID, ZEGO_SERVER_SECRET } from './config/env'
  ...
  useEffect(() => {
    ...
    (async () => {
      ...
      try {
        ...
        const socket = io(SOCKET_URL, { auth: { token }, path: SOCKET_PATH, transports: ['websocket'] })
